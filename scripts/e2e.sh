...
main() {
    ...
    operator-sdk test local github.com/appsody/appsody-operator/test/e2e --go-test-flags "-timeout 35m" --image $(oc registry info)/openshift/open-liberty-operator:$TRAVIS_BUILD_NUMBER --verbose
    result=$?
