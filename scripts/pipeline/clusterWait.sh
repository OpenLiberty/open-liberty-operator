...
olo_demand_id=$(get_env olo_DEMAND_ID_$arch)
export demandId=$olo_demand_id
...
if [[ "$rc" == 0 ]]; then
    echo "EBC create of id: $olo_demand_id cluster successful"
else
    echo "EBC create of id: $olo_demand_id cluster failed, ask #was-ebc slack channel for help mentioning your demand id: $olo_demand_id"
    exit 1
fi
