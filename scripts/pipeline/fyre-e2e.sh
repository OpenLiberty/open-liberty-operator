...
setup_env() {
    ...
    readonly BUILD_IMAGE="${REGISTRY_NAME}/${REGISTRY_NAMESPACE}/olo-operator:${RELEASE}"
    readonly BUNDLE_IMAGE="${REGISTRY_NAME}/${REGISTRY_NAMESPACE}/olo-operator:bundle-${RELEASE}"
