...
. Deploy the following template Grafana Dashboard [grafana_dashboard.yaml.txt](guides-code/grafana_datasource.yaml.txt) to see all the services currently being monitored.
