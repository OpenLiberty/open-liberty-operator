...
. Deploy the following template Grafana Dashboard [grafana_dashboard-4.6.yaml](code/grafana_datasource-4.6.yaml.txt) to see all the services currently being monitored.
