...
Follow this link:++https://docs.redhat.com/en/documentation/red_hat_openshift_logging/6.0/html/about_openshift_logging/quick-start[guide] to set up LokiStack and a ClusterLogForwarder in the `openshift-logging` namespace.
