...
| `topologySpreadConstraints` | Configures topology spread constraints for the application instance and if applicable, the Semeru Cloud Compiler instance. For examples, see link:#configuring-topology-spread-constraints[Configuring topology spread constraints].
...
* link:#configuring-topology-spread-constraints[Configuring topology spread constraints] (`.spec.topologySpreadConstraints`)
...
=== Configuring topology spread constraints (`.spec.topologySpreadConstraints`) [[configuring-topology-spread-constraints]]

Configure Topology Spread Constraints for the application instance (and if applicable, the Semeru Cloud Compiler instance) with the `.spec.topologySpreadConstraints` YAML object.
