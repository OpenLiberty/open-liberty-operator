...
* link:#override-console-logging-environment-variable-default-values[Override console logging environment variable default values (`.spec.env`)] image:images/docs_openliberty_logo.png[OL,25,25] 
* link:#configuring-single-sign-on-sso[Configuring single sign-on (SSO) (`.spec.sso`)] image:images/docs_openliberty_logo.png[OL,25,25] 
* link:#storage-for-serviceability[Storage for serviceability (`.spec.serviceability`)] image:images/docs_openliberty_logo.png[OL,25,25]
...
==== Override console logging environment variable default values (`.spec.env`) image:images/docs_openliberty_logo.png[OL,35,35] [[override-console-logging-environment-variable-default-values]]
...
==== Configuring single sign-on (SSO) (`.spec.sso`) image:images/docs_openliberty_logo.png[OL,35,35] [[configuring-single-sign-on-sso]]
...
==== Storage for serviceability (`.spec.serviceability`) image:images/docs_openliberty_logo.png[OL,35,35] [[storage-for-serviceability]]
