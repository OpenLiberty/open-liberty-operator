...
func createProviderService(t *testing.T, f *framework.Framework, ctx *framework.TestCtx, ns string, con string) error {
	ol := util.MakeBasicOpenLibertyApplicationImageStreams(t, f, olProvider, ns, 1)
	ol.Spec.Service.Provides = &v1beta1.ServiceBindingProvides{
		Category: "openapi",
		Context:  "/" + con,
	...
	err := f.Client.Create(goctx.TODO(), ol, &framework.CleanupOptions{TestContext: ctx, Timeout: timeout, RetryInterval: retryInterval})
	if err != nil {
		return err
	}
...
func createConsumeServiceMount(t *testing.T, f *framework.Framework, ctx *framework.TestCtx, ns string, n string, appName string, set bool) error {
	ol := util.MakeBasicOpenLibertyApplicationImageStreams(t, f, appName, ns, 1)
	if set == true {
		ol.Spec.Service.Consumes = []v1beta1.ServiceBindingConsumes{
...
func updateProviderTest(t *testing.T, f *framework.Framework, ctx *framework.TestCtx, ns string) error {
	...
	err = util.UpdateApplication(f, target, func(r *v1beta1.OpenLibertyApplication) {
