...
func (in *OpenLibertyApplicationSpec) DeepCopyInto(out *OpenLibertyApplicationSpec) {
	*out = *in
	...
	if in.ImportPolicy != nil {
		...
		*out = new(OpenLibertyManifestImportPolicy)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenLibertyManifestImportPolicy) DeepCopyInto(out *OpenLibertyManifestImportPolicy) {
	*out = *in
	if in.Insecure != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenLibertyManifestImportPolicy.
func (in *OpenLibertyManifestImportPolicy) DeepCopy() *OpenLibertyManifestImportPolicy {
	if in == nil {
		return nil
	}
	out := new(OpenLibertyManifestImportPolicy)
