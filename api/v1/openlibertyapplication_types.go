...
type OpenLibertyApplicationSpec struct {
	...
	// +operator-sdk:csv:customresourcedefinitions:order=36,type=spec,displayName="Hide Reconcile Interval"
...
func (cr *OpenLibertyApplication) GetReconcileIntervalHide() *bool {
...
func (s *OpenLibertyApplicationStatus) GetLastestTransitionTime() *metav1.Time {
