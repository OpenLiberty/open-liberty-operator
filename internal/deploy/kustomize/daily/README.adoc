...
'olo-ns' which should already exist. To install, run `kubectl create -k examples/watch-own-namespace`
...
and it will watch for resources in 'olo-watched-ns2'. To install run `kubectl create -k
examples/watch-another-namespace`
