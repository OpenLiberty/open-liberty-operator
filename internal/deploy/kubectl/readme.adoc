...
[source,sh]
----
kubectl apply --server-side -f https://raw.githubusercontent.com/OpenLiberty/open-liberty-operator/deploy-1.5.2/internal/deploy/kubectl/openliberty-app-crd.yaml
----
...
[source,sh]
----
curl -L https://raw.githubusercontent.com/OpenLiberty/open-liberty-operator/deploy-1.5.2/internal/deploy/kubectl/openliberty-app-rbac-watch-all.yaml \
...
[source,sh]
----
curl -L https://raw.githubusercontent.com/OpenLiberty/open-liberty-operator/deploy-1.5.2/internal/deploy/kubectl/openliberty-app-rbac-watch-another.yaml \
      | sed -e "s/OPEN_LIBERTY_OPERATOR_NAMESPACE/${OPERATOR_NAMESPACE}/" \
...
[source,sh]
----
curl -L https://raw.githubusercontent.com/OpenLiberty/open-liberty-operator/deploy-1.5.2/internal/deploy/kubectl/openliberty-app-operator.yaml \
      | sed -e "s/OPEN_LIBERTY_WATCH_NAMESPACE/${WATCH_NAMESPACE}/" \
